  ...
  (function ($) {
    $.fn.nekoScroll = function (option) {
      var defaultSetting = {
        ...
        borderRadius: 5 + 'px',
        right: 55.6 + 'px',
        nekoImg: "https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6804f29f58cb8da5c8ba1e38.png",
        hoverMsg: "回顶部?",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 22 && hnum >= 8
      ? `<img class='boardsign' src='https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/68b6bacf58cb8da5c872d015.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/68b6ba7958cb8da5c872cda7.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6801b74488c538a9b5da3b00.jpg);
    --darkmode-bg:url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6801b74488c538a9b5da3b00.jpg);
    --mobileday-bg: url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6801b74488c538a9b5da3b00.jpg);
    --mobilenight-bg: url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6801b74488c538a9b5da3b00.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6811d95758cb8da5c8d54b9d.webp)" class="imgbox" onclick="changeBg('url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/6811d95758cb8da5c8d54b9d.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/681209c158cb8da5c8d560e7.webp)" class="imgbox" onclick="changeBg('url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/681209c158cb8da5c8d560e7.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/681209d258cb8da5c8d560e8.webp)" class="imgbox" onclick="changeBg('url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/681209d258cb8da5c8d560e8.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/68120a4c58cb8da5c8d5610c.png)" class="imgbox" onclick="changeBg('url(https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/68120a4c58cb8da5c8d5610c.png)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 设置自定义背景 </summary>
              <div class='content'>
              <p><center><input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://blogsunweionline.oss-cn-guangzhou.aliyuncs.com/image/home_bg_fomal.webp"></center></p><p><center><button type="button" onclick="getPicture()" style="background:var(--theme-color);width:35%;padding: 5px 0px 7px 0px;border-radius:30px;color:white;line-height:2;">🌈切换背景🌈</button></center></p>
              </div>
            </details>
